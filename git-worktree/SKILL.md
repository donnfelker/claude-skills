---
name: git-worktree
description: Manages git worktrees including listing, creating, removing, and switching between worktrees. Use when the user mentions worktrees, parallel branches, or working on multiple branches simultaneously.
---
